...
<div class="card card-info">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="customer[customerId]" id="customerId" value="<?php echo $customer->customerId ?>" placeholder="customerId" hidden>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="customer[mobile]" id="mobile" value="<?php echo $customer->mobile ?>" placeholder="Mobile">
            </div>
        </div>
        <div class="form-group row">
