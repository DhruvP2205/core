...
<div class="card card-info">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="vendor[vendorId]" id="vendorId" value="<?php echo $vendor->vendorId ?>" placeholder="vendorId" hidden>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="vendor[mobile]" id="mobile" value="<?php echo $vendor->mobile ?>" placeholder="Mobile">
            </div>
        </div>
        <div class="form-group row">
